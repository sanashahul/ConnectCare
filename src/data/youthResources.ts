...
export const YOUTH_HOTLINES: YouthHotline[] = [
  {
    ...
    description: 'Free, confidential support for youth thinking about running away, or already on the streets. They can help you make a plan and find safe options. Text 66008 or call.',
    descriptionEs: 'Apoyo gratuito y confidencial para jóvenes que piensan en huir o que ya están en la calle. Pueden ayudarte a hacer un plan y encontrar opciones seguras. Envía texto al 66008 o llama.',
    available: '24/7',
    availableEs: '24/7',
    icon: '🏃',
  },
  ...
  },
  {
    ...
    description: 'Crisis support for LGBTQ+ young people. You can also text START to 678-678.',
    descriptionEs: 'Apoyo de crisis para jóvenes LGBTQ+. También puedes enviar START al 678-678.',
    available: '24/7',
    availableEs: '24/7',
    icon: '🌈',
  },
...
export const YOUTH_SHELTER_RESOURCES = {
  ...
  shelters: [
    ...
    },
    {
      ...
      description: 'Look for the yellow Safe Place sign at libraries, fire stations, and businesses. Text SAFE to 44357 (4HELP) for nearest location.',
      descriptionEs: 'Busca el letrero amarillo de Lugar Seguro en bibliotecas, estaciones de bomberos y negocios. Envía SAFE al 44357 para la ubicación más cercana.',
      phone: 'Text SAFE to 44357',
